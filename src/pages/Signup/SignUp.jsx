            ...
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <div className="card-body">
                        <h3 className="text-2xl font-semibold text-center">Please Sign Up</h3>
                        ...
                        <div className="form-control mt-6">
                            <input type="submit" className="btn bg-[#F53518] text-white hover:bg-[#F53518]" value="Sign Up" name="" id="" />
                            
                        </div>
                        </form>
                        <p>Already have an Account? <span className="font-bold text-[#F53518]"><Link to="/">Sign Up</Link></span></p>
                    </div>
                </div>
            </div>
        </div>
